...
const modules: Module[] = [
  ...
  },
  {
    ...
    frs: [
      ...
      { id: 'FR-TXT-005', title: 'SEO 优化规则', desc: '检查关键词覆盖、密度、标题质量、可读性、事实来源、CTA 与平台适配，输出评分和问题建议。' },
      { id: 'FR-TXT-006', title: '长尾关键词建议', desc: '展示推荐长尾关键词，点击可复制，带反馈。' },
      { id: 'FR-TXT-007', title: '图文混排预览', desc: '正文与配图按所选配图尺寸渲染。' },
      { id: 'FR-TXT-008', title: '一键复制', desc: '复制正文，带「已复制」反馈。' },
      { id: 'FR-TXT-009', title: '生成过程动效', desc: '按解析选题 → 生成大纲 → 撰写正文 → 优化标签配图四阶段渲染。' },
    ],
